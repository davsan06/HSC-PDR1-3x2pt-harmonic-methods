...
saccfile = os.path.expanduser(
    os.path.expandvars("/pscratch/sd/d/davidsan/3x2pt-HSC/HSC-3x2pt-methods/data-vectors/all/noise_added/summary_statistics_fourier_all_WL_cuts_GC_0.15_cuts_plus_noise.sacc")
)
