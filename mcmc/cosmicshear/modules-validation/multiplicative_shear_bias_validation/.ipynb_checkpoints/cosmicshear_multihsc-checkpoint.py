...
# nlia = wl.NonLinearAlignmentSystematic(sacc_tracer="")

for i in range(4):
    
    print(f'Generating source {i+1}')
    """
    ...
    sources[f"source_{i}"] = wl.WeakLensing(sacc_tracer=f"source_{i}", systematics=[multbias])
